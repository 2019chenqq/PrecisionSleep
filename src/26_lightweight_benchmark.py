...
model = RandomForestClassifier(
    ...
    # Stage 26:
    # use single-core reference for lightweight benchmark
    n_jobs=1,
)
...
model_path = (
    results_dir
    / "stage26_random_forest_model.joblib"
)
...
report_path = (
    results_dir
    / f"stage26_demo_report_{test_subject}.png"
)
...
metrics_path = (
    results_dir
    / f"stage26_benchmark_{test_subject}.csv"
)
...
print("\nStage 26 completed successfully.")